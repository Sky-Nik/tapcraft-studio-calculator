...
import { Info, ChevronDown, ChevronRight, Layers, FileText } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-[hsl(224,20%,9%)] rounded-2xl border border-white/[0.06] overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <FieldWithTooltip label="Hardware Cost ($)" tooltip="Bolts, inserts, magnets, etc.">
              <Input
                type="number"
                className={inputClass}
                placeholder="0.00"
                value={inputs.hardwareCost || ""}
                onChange={(e) => handleInput("hardwareCost", parseFloat(e.target.value) || 0)}
              />
            </FieldWithTooltip>
