...
const pageTitles = {
  ...
  Reports: "CRM Reports",
  SocialLibrary: "Media Library",
  SocialCampaigns: "Campaigns",
  SocialCalendar: "Content Calendar",
...
const pageBreadcrumbs = {
  ...
  Contacts: ["Home", "CRM", "Contacts"],
  Deals: ["Home", "CRM", "Deals"],
  Tasks: ["Home", "CRM", "Tasks"],
  Communications: ["Home", "CRM", "Communications"],
  Reports: ["Home", "CRM", "Reports"],
  SocialLibrary: ["Home", "Social Media", "Library"],
  SocialCampaigns: ["Home", "Social Media", "Campaigns"],
  SocialCalendar: ["Home", "Social Media", "Calendar"],
  SocialConnections: ["Home", "Social Media", "Connections"],
  SocialAnalytics: ["Home", "Social Media", "Analytics"],
  Sales: ["Home", "Sales"],
  InventoryManager: ["Home", "Tools", "Inventory Manager"],
